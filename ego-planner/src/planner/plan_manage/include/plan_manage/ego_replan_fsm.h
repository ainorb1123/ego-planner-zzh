...
namespace ego_planner
{
  ...
  private:
    ...
    ros::Subscriber obs_overtake_sub_, obs_headon_sub_, obs_port_cross_sub_, obs_stbd_cross_sub_;
    void dynamicObstacleCallback(const nav_msgs::OdometryConstPtr& msg, std::string name);
